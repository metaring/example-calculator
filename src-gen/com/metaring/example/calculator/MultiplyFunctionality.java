...
abstract class MultiplyFunctionality extends AbstractFunctionality implements GeneratedFunctionality {

    static final FunctionalityInfo INFO = FunctionalityInfo.create("com.metaring.example.calculator.multiply", false, false, false, "com.metaring.example.calculator.OperandsModel", "java.lang.Double");

    static final MultiplyFunctionality INSTANCE = new MultiplyFunctionalityImpl();

    protected MultiplyFunctionality() {
