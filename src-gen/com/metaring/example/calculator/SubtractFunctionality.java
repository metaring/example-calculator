...
abstract class SubtractFunctionality extends AbstractFunctionality implements GeneratedFunctionality {

    static final FunctionalityInfo INFO = FunctionalityInfo.create("com.metaring.example.calculator.subtract", false, false, false, "com.metaring.example.calculator.OperandsModel", "java.lang.Double");

    static final SubtractFunctionality INSTANCE = new SubtractFunctionalityImpl();

    protected SubtractFunctionality() {
