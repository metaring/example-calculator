...
abstract class SumFunctionality extends AbstractFunctionality implements GeneratedFunctionality {

    static final FunctionalityInfo INFO = FunctionalityInfo.create("com.metaring.example.calculator.sum", false, false, false, "com.metaring.example.calculator.OperandsModel", "java.lang.Double");

    static final SumFunctionality INSTANCE = new SumFunctionalityImpl();

    protected SumFunctionality() {
